...
void update(void);
void print(void);
void sort_parts(struct part a[], int low, int high);
...
void insert(void) {
  ...
  num_parts++;
  sort_parts(inventory, 0, num_parts - 1);
}
...
void sort_parts(struct part a[], int low, int high) {
  ...
  middle = sort_parts_split(a, low, high);
  sort_parts(a, low, middle - 1);
  sort_parts(a, middle + 1, high);
}

int sort_parts_split(struct part a[], int low, int high) {
